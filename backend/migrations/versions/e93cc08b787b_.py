...
Revision ID: e93cc08b787b
Revises: 
Create Date: 2019-09-17 17:47:00.655067
...
def upgrade():
    ...
    sa.Column('modified_by', sa.String(length=128), nullable=True),
    sa.Column('modified_on', sa.DateTime(), nullable=True),
    sa.Column('plan_details', sa.String(length=512), nullable=True),
    ...
    sa.Column('appointment_status', sa.Integer(), nullable=True),
    sa.Column('appointment_type', sa.Integer(), nullable=True),
