...
class UserDto:
    ...
    user = api.model('user', {
        ...
        'social_security_number' : fields.Integer(description='Social Security Number')
    })
    ...
    doctor = api.model('doctor', {
        ...
        'provider_id' : fields.Integer(description='Provider Id'),
        'stakeholder_id' : fields.Integer(description='Stakeholder Id'),
        'duty_start_time' : fields.String(description='Duty Start Time'),
        'duty_end_time' : fields.String(description='Duty End Time'),
        'social_security_number' : fields.Integer(description='Social Security Number')
    })
...
class PlanDto():
    ...
    providerPlan = api.model('providerPlan',{
        ...
        'plan_details' : fields.String(description='plan details'),
        })   
...
class AppointmentDto():
    ...
    appointment = api.model('appointment',{
        'appointment_id': fields.Integer(required=False, description='id'),
        'appointment_date' : fields.String(description='Appointment date'),
        'created_by' : fields.String(description='created by')
        })   


    """Make Appointment Dto"""
    makeAppointment = api.model('makeAppointment',{
        'id': fields.Integer(required=False, description='id'),
        'patient_id': fields.Integer(required=True, description='patient id'),
        'doctor_id': fields.Integer(required=True, description='doctor id'),
        'created_by' : fields.String(description='created by'),
        'appointment_date' : fields.String(description='Appointment date'),
        'appointment_type': fields.Integer(required=True, description='appointment type'),
        })  

   
    """Pending Appointment Dto"""
    pendingAppointment = api.model('pendingAppointment',{
        'appointment_id': fields.Integer(required=False, description='appointment id')
        })   

    """Appointment Details Dto"""
    appointmentDetails = api.model('appointmentDetails',{
        'appointment_id': fields.Integer(required=False, description='appointment id')
        })       


    """ Appointment Type Dto """
    appointmentType = api.model('appointmentType',{
        'id': fields.Integer(required=False, description='id'),
        'name': fields.String(required=True, description='appointment type name'),         
        'description': fields.String(description='appointment type description'),
        'tags' : fields.String(description='search index tags'),
        'created_by' : fields.String(description='created by'),
        'user_id': fields.Integer(required=True, description='user id'),
        })   
